...
The Pathway Technologies newsletter provides occasional updates on:

- Engineering practices in regulated environments  
- DevOps, compliance, and traceability topics  
- Relevant developments affecting technical and safety-critical systems  

The newsletter is low-frequency and focused on technical and regulatory topics.

## Subscribe

To subscribe, please provide your email address using the form below.
...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="max-width:540px; text-align:center; background-color:rgba(255,255,255,1); border-width:1px; border-style:solid; border-color:#C0CCD9; border-radius:3px; direction:ltr">
      <form id="sib-form" method="POST" action="https://887d31ec.sibforms.com/serve/MUIFAGzN3v_FuuaBLAXs0UunwcmvSgkaQFOnzL0FgriPxQt3oDSDoFeQglLlxyl_pcVHrQ70O3mrlDkYm_oZkTv0vga4JMCFoRo3V5WGko3NgSnPYs6F9gYZpIE76bp-VTOBoNtuKMwssMzUaqbbRQRzFYZmQ9NTavDrXRp4-prPnpY_EVWkGrhjwaAxDu9WXD_j61ZHhtXOfgJc" data-type="subscription">
          ...
          <div class="sib-optin sib-form-block" data-required="true">
            <div class="form__entry entry_mcq">
              <div class="form__label-row ">
                ...
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:Helvetica, sans-serif; font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="OPT_IN" data-required="*">Opt-in</label>
            ...
            style="margin-left:"
            ></span><span style="font-family:Helvetica, sans-serif; font-size:14px; text-align:left; color:#3C4858; background-color:transparent;"><p>I agree to receive the Pathway Technologies newsletter. I understand that my email will be used for this purpose in accordance with the Privacy Policy.</p></span>
...
By subscribing, you agree to the processing of your email address
for the purpose of receiving this newsletter.

- Subscription is voluntary and based on your explicit consent  
- Your email address will not be shared or sold to third parties  
- You may unsubscribe at any time using the link included in each email  
- Further details are available in the <a href="/privacy/">Privacy Policy</a>  

## Notes

Subscriptions are managed using an email service provider selected
with consideration for data protection and regulatory alignment.